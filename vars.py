...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8479840767:AAETlbHcKIM0PEh0dxJJqXhcfKdUB9fEXVM")

CREDIT = os.environ.get("CREDIT", "🎉")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "CpprivateApi")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Admin:golu1234@cluster0.bcz3n2q.mongodb.net/?retryWrites=true&w=majority")  # Add your own atlas db
